...
public class GameManager : MonoBehaviour {
	...
	public float metralhadora = 0f;
	public float tempoMetralhadora = 5f;
	...
	public void targetHit (int scoreAmount, float timeAmount, float tempoMetralhadora)
	{
		// increase the score by the scoreAmount and update the text UI
		score += scoreAmount;
		mainScoreDisplay.text = score.ToString ();

		metralhadora += tempoMetralhadora;
