...
public class ComportamentoBoost : MonoBehaviour
{

	// impacto do alvo no jogo
	public int pontuacao = 0;
	public float tempoExtra = 5.0f;
	public float tempoMetralhadora = 3;
	...
	void OnCollisionEnter (Collision newCollision)
	{
		...
		if (newCollision.gameObject.tag == "Player") {
			...
			if (GameManager.gm) {
				GameManager.gm.targetHit (pontuacao, tempoExtra, tempoMetralhadora);
			}
