...
public class Tiro : MonoBehaviour {
	...
	private float tempoDoUltimoTiro = 0;
	...
	void Update () {
		...
		if (((GameManager.gm.metralhadora > 0) && (Input.GetButton("Fire1") || Input.GetButton("Jump"))) || (Input.GetButtonDown("Fire1") || Input.GetButtonDown("Jump")))
		//if (Input.GetButtonDown("Fire1") || Input.GetButtonDown("Jump"))
		if (Input.GetButton("Fire1") || Input.GetButton("Jump"))
		{
			// se o projetil foi definido
			if (Time.timeSinceLevelLoad - tempoDoUltimoTiro > intervalo) {
				tempoDoUltimoTiro = Time.timeSinceLevelLoad;
